...
namespace rc
{
    struct ObjectPanel : Component
    {
        private:
            ...
            TextField _lightIntensityField; //todo voir si on le met dans les objectSliders ?
        ...
        public:
            ...
            void setFont(sf::Font &font) override
            {
                ...
                // this->_lightIntensityField.setLabel("Light intensity");
